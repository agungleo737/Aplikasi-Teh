    ...
    private void doLogin() {
        ...
        api.login(email, password).enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                try {
                    ...
                    if (response.isSuccessful() && obj.optBoolean("success")) {
                        ...
                        sessionManager.savesession(token, user.getString("name"), user.getString("email"));

                        Toast.makeText(login.this, "Login berhasil!", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(login.this, MainActivity.class));
                        finish();
                    } else {
                        Toast.makeText(login.this, obj.optString("message", "Login gagal"), Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                Toast.makeText(login.this, "Gagal konek ke server: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}